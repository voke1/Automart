...
var Car = {
  ...
  getAvailableCarsByMake: function getAvailableCarsByMake(req, res) {
    var carsArray = _car_model["default"].findAvailableCarsByMake(req.params.manufacturer, req.query.status);
  ...
  getCarByBodyType: function getCarByBodyType(req, res) {
    try {
      var data = _car_model["default"].findCarByBodyType(req.query.status, req.query.body_type);
  ...
  getUsedAvailableCars: function getUsedAvailableCars(req, res) {
    var newAvailable = _car_model["default"].findNewAvailableCars(req.query.status, req.query.state, req.body.manufacturer);
  ...
  getNewAvailableCars: function getNewAvailableCars(req, res) {
    var newAvailable = _car_model["default"].findNewAvailableCars(req.query.status, req.query.state, req.body.manufacturer);
